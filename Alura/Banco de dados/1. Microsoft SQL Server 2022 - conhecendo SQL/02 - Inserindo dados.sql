...
'1965-03-21', 57, 'M', 20000000, 3000.30, 1),
...
([CPF], [NOME], [RUA], [BAIRRO], [CIDADE], [ESTADO], [CEP], [DATA DE NASCIMENTO],
[IDADE], [SEXO], [LIMITE DE CREDITO], [VOLUME MINIMO], [PRIMEIRA COMPRA])
VALUES

('1471156710', 'Erica Carvalho', 'R. Iriquitia', 'Jardins', 'Sao Paulo', 'SP', '80012212',
'1990-09-01', 33, 'F', 1700000000, 24500, 0),
('19290992743', 'Fernando Cavalcante', 'R. Dois de Fevereiro', 'Agua Santa', 'Rio de Janeiro', 'RJ', '22000000',
'2000-02-12', 23, 'M', 1000000000, 20000, 1),
('2600586709', 'Cesar Teixeira', 'Rua Conde de Bonfim', 'Tijuca', 'Rio de Janeiro', 'RJ', '22020001',
'2000-03-12', 23, 'M', 1200000000, 22000, 0),
('3623344710', 'Marcos Nogueira', 'Av. Pastor Martin Luther King Junior', 'Inhauma', 'Rio de Janeiro', 'RJ', '22002012',
'1995-01-13', 28, 'M', 1100000000, 22000, 1),
('492472718', 'Eduardo Jorge', 'R. Volta Grande', 'Tijuca', 'Rio de Janeiro', 'RJ', '22012002',
'1994-07-19', 29, 'M', 750000000, 9500,	1),
('50534475787', 'Abel Silva', 'Rua Humaita', 'Humaita', 'Rio de Janeiro', 'RJ', '22000212',
'1995-09-11', 28, 'M', 1700000000, 26000, 0),
('5576228758', 'Petra Oliveira', 'R. Benicio de Abreu', 'Lapa', 'Sao Paulo', 'SP', '88192029',
'1995-11-14', 28, 'F', 700000000, 16000, 1),
('5648641702', 'Paulo Cesar Mattos', 'Rua Helio Beltrao', 'Tijuca', 'Rio de Janeiro', 'RJ', '21002020',
'1991-08-30', 32, 'M', 1200000000, 22000, 0),
('5840119709', 'Gabriel Araujo', 'R. Manuel de Oliveira', 'Santo Amaro', 'Sao Paulo', 'SP', '80010221',
'1985-03-16', 38, 'M', 1400000000, 21000, 1),
('7771579779', 'Marcelo Mattos', 'R. Eduardo Luís Lopes', 'Bras', 'Sao Paulo', 'SP', '88202912',
'1992-03-25', 31, 'M', 1200000000, 20000, 1),
('8502682733', 'Valdeci da Silva', 'R. Srg. Edison de Oliveira', 'Jardins', 'Sao Paulo', 'SP', '82122020',
'1995-10-07', 28, 'M', 1100000000, 19000, 0),
('8719655770', 'Carlos Eduardo', 'Av. Gen. Guedes da Fontoura', 'Jardins', 'Sao Paulo', 'SP', '81192002',
'1983-12-20', 39, 'M', 2000000000, 24000, 0),
('9283760794', 'Edson Meilelles', 'R. Pinto de Azevedo', 'Cidade Nova', 'Rio de Janeiro', 'RJ', '22002002',
'1995-10-07', 28, 'M', 1500000000, 25000, 1),
('94387575700', 'Walber Lontra', 'R. Cel. Almeida', 'Piedade', 'Rio de Janeiro', 'RJ', '22000201',
'1989-06-20',  34, 'M', 600000000, 12000, 1),
('95939180787', 'Fabio Carvalho', 'R. dos Jacarandas da Peninsula', 'Barra da Tijuca', 'Rio de Janeiro', 'RJ', '22002020',
'1992-01-05',  31, 'M', 900000000, 18000, 1);
